...
class TestCompiler < Minitest::Test
  ...
  def test_nested_operations
    ...
    expected_output = "2 + (3 * (10 - (6 ^ 4)))"  # Add parentheses for clarity
    assert_equal expected_output, Compiler.new(input).compile
  ...
  def test_ternary_operation
    ...
    expected_output = "(1 + 2 ? (3 - 1) : (2 * 2))"  # Add parentheses for clarity
    assert_equal expected_output, Compiler.new(input).compile
  ...
  def test_complex_expression
    ...
    expected_output = "1 + ((5 - 2) * (8 / 4))"  # Add parentheses for clarity
    assert_equal expected_output, Compiler.new(input).compile
  ...
  def test_multiple_operations
    ...
    expected_output = "((3 * 4) + (10 - (20 / 5)))"  # Add parentheses for clarity
    assert_equal expected_output, Compiler.new(input).compile
  ...
  def test_multiple_nested_operations
    ...
    expected_output = "((2 * 3) + (2 ^ 3))"  # Add parentheses for clarity
    assert_equal expected_output, Compiler.new(input).compile
